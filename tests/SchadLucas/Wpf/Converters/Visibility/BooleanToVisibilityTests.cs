...
namespace SchadLucas.Wpf.Converters.Tests.Visibility
{
    ...
    public class BooleanToVisibilityTests : EzTest
    {
        private static readonly ValueConverSutHelper Converter = new ValueConverSutHelper(() => new BooleanToVisibility());

        [TestMethod]
        public void ConvertBackTest()
        {
            Assert.AreEqual(true, Converter.ConvertBack<bool>(System.Windows.Visibility.Visible));
            Assert.AreEqual(false, Converter.ConvertBack<bool>(System.Windows.Visibility.Collapsed));
            Assert.AreEqual(false, Converter.ConvertBack<bool>(System.Windows.Visibility.Hidden));
        }
        ...
        {
            Assert.AreEqual(System.Windows.Visibility.Visible, Converter.Convert<System.Windows.Visibility>(true));
            Assert.AreEqual(System.Windows.Visibility.Collapsed, Converter.Convert<System.Windows.Visibility>(false));
        }
