...
namespace SchadLucas.Wpf.EzMvvm.Services
{
    ...
    public sealed class MessageHubErrorEventArgs : EventArgs
    {
        ...
        /// <param name="token">
        ///     The subscription token of the subscriber to which message was published by the
        ...
        /// <summary>
        ///     Gets the subscription token of the subscriber to which message was published by the
        ///     <see cref="IMessageHub" />.
        /// </summary>
